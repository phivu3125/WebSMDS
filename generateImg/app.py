...
def run_generation():
    ...
    try:
        ...
        integration_prompt = """Insert the first image as the main central content in the bank note. Make it look borderlessly integrated into the banknote and preserving all banknote frames"""
